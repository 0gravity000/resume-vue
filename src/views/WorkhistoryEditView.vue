      ...
      <form>
        <div class="row g-3">
          <div class="col-2">
            ...
            <select v-model="this.WorkhistoryModel.event_year" class="form-select">
          ...
          <div class="col-2">
            ...
            <select v-model="this.WorkhistoryModel.event_month" class="form-select">
...
export default {
  ...
  methods: {
    updateAuthInfo(data) {
      console.log("WorkhistoryEditView：")
      console.log(data)
