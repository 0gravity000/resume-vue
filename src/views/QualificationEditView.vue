      ...
      <form>
        <div class="row g-3">
          <div class="col-2">
            ...
            <select v-model="this.QualificationModel.qualification_year" class="form-select">
          ...
          <div class="col-2">
            ...
            <select v-model="this.QualificationModel.qualification_month" class="form-select">
